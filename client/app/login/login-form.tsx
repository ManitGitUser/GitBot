            ...
            <main className="relative z-10 flex flex-1 items-center justify-center px-4 py-10">
                <Card className="w-full max-w-sm border-border/70 bg-card/90 shadow-lg shadow-foreground/5 backdrop-blur-xl">
                    <CardHeader className="space-y-4 text-center">
                        <div className="mx-auto flex size-12 items-center justify-center rounded-2xl overflow-hidden shadow-sm">
                            <GitBotIcon className="size-12 rounded-2xl" />
                        </div>
                        <div className="space-y-1">
                            <CardTitle className="text-xl">Sign in to GitBot</CardTitle>
                            <CardDescription>
